...
| 1.0.116        | https://github.com/lorint/brick/blob/v1.0/README.md   |
...
and an intriguing snappy little thing **[motor](https://github.com/motor-admin/motor-admin-rails)**.  Each of these has its own strengths and weaknesses, and Brick allows you to evaluate them all -- even all of them at once in the same project if you want!
...
`bin/rails g rails_admin:install`.  Same kind of idea for Trestle or ActiveAdmin, and both of those will also need `gem 'sassc-rails'`.
Just remember that although it might be described in their documentation that you have to scaffold up resource files or
controllers, with Brick that's not necessary since all of that gets auto-generated by Brick.  This provides by far the fastest
way to test out various administrative interfaces in any Rails app.
