...
| 1.0.113        | https://github.com/lorint/brick/blob/v1.0/README.md   |
...
without the headaches of having to use older versions of Ruby.  If you're using Ruby 2.7.7 then
...
Brick auto-detects the **[rails_admin](https://github.com/railsadminteam/rails_admin/)**,
**[trestle](https://github.com/TrestleAdmin/trestle)**, and **[avo](https://github.com/avo-hq/avo)** gems and will
...
or Avo then of course `gem 'avo'` and `bin/rails g avo:install`.  Same idea for Trestle, and might also
need `gem 'sassc'` for that one.  The great thing is that after dropping in one of these gems and
creating its initializer, there's no need to add any resources or other additional files!  All of that
gets auto-generated by Brick.  These options are by far the fastest way to get an administrative
interface up and going for any Rails app.
