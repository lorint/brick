...
| 1.0.194        | https://github.com/lorint/brick/blob/v1.0/README.md   |
...
Brick also knows how to deal with model namespacing via modules, building out controller modules as appropriate.
