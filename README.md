...
| 1.0.115        | https://github.com/lorint/brick/blob/v1.0/README.md   |
...
and **[avo](https://github.com/avo-hq/avo)** gems and will
...
or Avo then of course `gem 'avo'` and `bin/rails g avo:install`.  Same idea for Trestle or ActiveAdmin,
and might also need `gem 'sassc'` for those.  The great thing is that after dropping in one of these gems and
